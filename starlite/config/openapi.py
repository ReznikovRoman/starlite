...
from pydantic import AnyUrl  # noqa: TC002
...
from starlite.types.callable_types import OperationIDCreator  # noqa: TC001
...
class OpenAPIConfig:
    ...
    openapi_controller: type[OpenAPIController] = field(default=OpenAPIController)
    ...
    terms_of_service: AnyUrl | None = field(default=None)
    ...
    """
    root_schema_site: Literal["redoc", "swagger", "elements"] = field(default="redoc")
    ...
    by_alias: bool = field(default=True)
    """Render pydantic model schema using field aliases, if defined."""
    operation_id_creator: OperationIDCreator = field(default=default_operation_id_creator)
